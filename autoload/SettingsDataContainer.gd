...
func create_keybind_dictionary() -> Dictionary:
	var keybinds_container_dict = {
		...
		KEYBIND_RESOURCE.CONTROLLER_AIM_UP_STICK : KEYBIND_RESOURCE.controller_aim_up_stick,
		KEYBIND_RESOURCE.CONTROLLER_AIM_DOWN_STICK : KEYBIND_RESOURCE.controller_aim_down_stick,
		KEYBIND_RESOURCE.CONTROLLER_AIM_RIGHT_STICK : KEYBIND_RESOURCE.controller_aim_right_stick,
		KEYBIND_RESOURCE.CONTROLLER_AIM_LEFT_STICK : KEYBIND_RESOURCE.controller_aim_left_stick
	}
...
func get_keybind(action: String, default : bool = false):
	if !loaded_data.has("keybinds") || default:
		match action:
			...
			KEYBIND_RESOURCE.CONTROLLER_AIM_UP_STICK: return KEYBIND_RESOURCE.DEFAULT_CONTROLLER_AIM_UP_STICK
			KEYBIND_RESOURCE.CONTROLLER_AIM_DOWN_STICK: return KEYBIND_RESOURCE.DEFAULT_CONTROLLER_AIM_DOWN_STICK
			KEYBIND_RESOURCE.CONTROLLER_AIM_RIGHT_STICK: return KEYBIND_RESOURCE.DEFAULT_CONTROLLER_AIM_RIGHT_STICK
			KEYBIND_RESOURCE.CONTROLLER_AIM_LEFT_STICK: return KEYBIND_RESOURCE.DEFAULT_CONTROLLER_AIM_LEFT_STICK
		...
		match action:
			...
			KEYBIND_RESOURCE.CONTROLLER_AIM_UP_STICK: return KEYBIND_RESOURCE.controller_aim_up_stick
			KEYBIND_RESOURCE.CONTROLLER_AIM_DOWN_STICK: return KEYBIND_RESOURCE.controller_aim_down_stick
			KEYBIND_RESOURCE.CONTROLLER_AIM_RIGHT_STICK: return KEYBIND_RESOURCE.controller_aim_right_stick
			KEYBIND_RESOURCE.CONTROLLER_AIM_LEFT_STICK: return KEYBIND_RESOURCE.controller_aim_left_stick
...
func set_keybind(action: String, event) -> void:
	match action:
		...
		KEYBIND_RESOURCE.CONTROLLER_AIM_UP_STICK: KEYBIND_RESOURCE.controller_aim_up_stick = event
		KEYBIND_RESOURCE.CONTROLLER_AIM_DOWN_STICK: KEYBIND_RESOURCE.controller_aim_down_stick = event
		KEYBIND_RESOURCE.CONTROLLER_AIM_RIGHT_STICK: KEYBIND_RESOURCE.controller_aim_right_stick = event
		KEYBIND_RESOURCE.CONTROLLER_AIM_LEFT_STICK: KEYBIND_RESOURCE.controller_aim_left_stick = event
...
func on_keybinds_loaded(data: Dictionary) -> void:
	...
	KEYBIND_RESOURCE.CONTROLLER_AIM_UP_STICK, KEYBIND_RESOURCE.CONTROLLER_AIM_DOWN_STICK,
	KEYBIND_RESOURCE.CONTROLLER_AIM_RIGHT_STICK, KEYBIND_RESOURCE.CONTROLLER_AIM_LEFT_STICK]
